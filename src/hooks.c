...
/*   Updated: 2025/03/28 14:51:57 by yhusieva         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/minirt.h"

void move(t_minirt *minirt, int xyz, float *coord, int arithmetic)
{
    if (arithmetic == 0)
        *coord -= TRANSLATION;
    if (arithmetic == 1)
...
void redirect(t_minirt *minirt, int xyz, float *coord, int arithmetic)
{
    if (arithmetic == 0)
...
//     if (mlx_is_key_down(minirt->mlx, MLX_KEY_D))
//     {
//         minirt->scene->c.point.x += TRANSLATION_CONST;
//         printf("x: ");
//         print_coord(minirt->scene->c.point);
//         generate_image(minirt);
//     }
...
//     if (mlx_is_key_down(minirt->mlx, MLX_KEY_W))
//     {
//         minirt->scene->c.point.y += TRANSLATION_CONST;
//         printf("y: ");
//         print_coord(minirt->scene->c.point);
//         generate_image(minirt);
//     }
...
//     if (mlx_is_key_down(minirt->mlx, MLX_KEY_UP))
//     {
//         minirt->scene->c.point.z += TRANSLATION_CONST;
//         printf("z: ");
//         print_coord(minirt->scene->c.point);
//         generate_image(minirt);
//     }
